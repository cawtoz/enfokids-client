...
const therapistSchema = z.object({
  ...
  speciality: z.string().min(3, "La especialidad debe tener al menos 3 caracteres"),
})
...
export interface TherapistFormProps {
  ...
  onSubmit: (data: CreateTherapistRequest) => Promise<void>
...
export function TherapistForm({
  ...
  const handleSubmit = async (data: TherapistFormValues) => {
    await onSubmit(data)
  }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Especialidad del terapeuta" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
